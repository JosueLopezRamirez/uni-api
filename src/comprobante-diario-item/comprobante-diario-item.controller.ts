...
export class ComprobanteDiarioItemController {
  constructor(private readonly comprobanteDiarioItemService: ComprobanteDiarioItemService) {}

  @Post()
  create(@Body() createComprobanteDiarioItemDto: CreateComprobanteDiarioItemDto) {
    return this.comprobanteDiarioItemService.create(createComprobanteDiarioItemDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateComprobanteDiarioItemDto: UpdateComprobanteDiarioItemDto) {
    return this.comprobanteDiarioItemService.update(+id, updateComprobanteDiarioItemDto);
  }
