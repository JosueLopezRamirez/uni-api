...
export class HistorialComprobanteDiarioController {
  ...
  create(
    ...
    return this.historialComprobanteDiarioService.create(
      createHistorialComprobanteDiarioDto,
    );
  }
  ...
  update(
    ...
    return this.historialComprobanteDiarioService.update(
      id,
      updateHistorialComprobanteDiarioDto,
    );
  }
