...
export class HistorialFacturasController {
  constructor(private readonly historialFacturasService: HistorialFacturasService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateHistorialFacturaDto: UpdateHistorialFacturaDto) {
